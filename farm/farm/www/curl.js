/**
 * curl.js 1.4 (10-Aug-2010) (c) by Christian Effenberger 
...
if(window.addEventListener) window.addEventListener("load",addCurl,false);
else window.attachEvent("onload",addIECurl);